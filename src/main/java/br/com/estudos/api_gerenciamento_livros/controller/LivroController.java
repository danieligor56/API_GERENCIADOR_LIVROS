...
public class LivroController {
	...
	@Operation (summary = "Procurar livro ", description  =  "Faz a busca do livro utilizando o ID")
	 @ApiResponses(value = {
		        @ApiResponse(responseCode = "200", description = "OK,LIVRO ENCONTRADO.", content = { @Content(mediaType = "application/json", schema = @Schema(implementation = LivroEntity.class)) }),
		        @ApiResponse(responseCode = "404", description = "LIVRO NÃO ENCONTRADO.", content = { @Content(mediaType = "application/json", schema = @Schema(implementation = NotFound.class)) })
		    })
